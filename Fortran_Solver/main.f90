Program test2d
    Use Variabili
    Implicit none
    character(80):: residuals, entropy
	...
	do k=1,kfinal
		...
		if(mod(k,kout).eq.0)then
            ...
            write(90,*) k,',',norm2_residuals(1),',',norm2_residuals(2),',',norm2_residuals(3),',',norm2_residuals(4)
            write(91,*) k,',',norm2_entropy
		end if
